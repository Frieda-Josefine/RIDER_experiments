...
function timeout_pLoopBegin(timeout_pLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTimeout_p of timeout_p) {
...
function trials_attLoopBegin(trials_attLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTrials_att of trials_att) {
...
function training_stimRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of training_stimComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function retrocue_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of retrocue_trainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function training_ori_adjustmentRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of training_ori_adjustmentComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function timeout_pracRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of timeout_pracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function testing_startRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of testing_startComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function presentation_stimsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of presentation_stimsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function timeout_LTMRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of timeout_LTMComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
async function quitPsychoJS(message, isCompleted) {
  ...
  // Example for error checking - will show an alert, if something went wrong.
